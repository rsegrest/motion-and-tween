...
import { EaseInExponentialTween, EaseOutExponentialTween, EaseInOutExponentialTween } from "../tween/exponential";
import { EaseInQuadraticTween, EaseOutQuadraticTween, EaseInOutQuadraticTween } from '../tween/quadratic'
import { EaseInQuarticTween, EaseOutQuarticTween, EaseInOutQuarticTween } from "../tween/quartic";
import { EaseOutQuinticTween, EaseInQuinticTween, EaseInOutQuinticTween } from "../tween/quintic";
import { EaseInSinusoidalTween, EaseOutSinusoidalTween, EaseInOutSinusoidalTween } from "../tween/sinusoidal";
...
describe("Tween", () => {
    ...
    it('should setParams', () => {
        ...
        const { lastT, nextT, actionDuration: duration, beginValue, valueChange } = linearTween.setParams({t: 1});
        expect(lastT).toBe(0);
        expect(nextT).toBe(1);
    ...
    describe('Circular Tweening algorithms', () => {
        it("should do an ease-in circular tween", () => { 
            ...
            let easeInCircularTween: EaseInCircularTween = new EaseInCircularTween(tp);
            expect(easeInCircularTween).toBeDefined();
            expect(easeInCircularTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInCircularTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out circular tween", () => { 
            ...
            let easeOutCircularTween: EaseOutCircularTween = new EaseOutCircularTween(tp);
            expect(easeOutCircularTween).toBeDefined();
            expect(easeOutCircularTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutCircularTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out circular tween", () => { 
            ...
            let easeInOutCircularTween: EaseInOutCircularTween = new EaseInOutCircularTween(tp);
            expect(easeInOutCircularTween).toBeDefined();
            expect(easeInOutCircularTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutCircularTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
    ...
    describe('Cubic Tweening algorithms', () => {
        it("should do an ease-in cubic tween", () => { 
            ...
            expect(easeInCubicTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInCubicTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out cubic tween", () => { 
            ...
            let easeOutCubicTween: EaseOutCubicTween = new EaseOutCubicTween(tp);
            expect(easeOutCubicTween).toBeDefined();
            expect(easeOutCubicTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutCubicTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out cubic tween", () => { 
            ...
            let easeInOutCubicTween: EaseInOutCubicTween = new EaseInOutCubicTween(tp);
            expect(easeInOutCubicTween).toBeDefined();
            expect(easeInOutCubicTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutCubicTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
    ...
    describe('Exponential Tweening algorithms', () => {
        it("should do an ease-in exponential tween", () => { 
            ...
            let easeInExponentialTween: EaseInExponentialTween = new EaseInExponentialTween(tp);
            expect(easeInExponentialTween).toBeDefined();
            expect(easeInExponentialTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInExponentialTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out exponential tween", () => { 
            ...
            let easeOutExponentialTween: EaseOutExponentialTween = new EaseOutExponentialTween(tp);
            expect(easeOutExponentialTween).toBeDefined();
            expect(easeOutExponentialTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutExponentialTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out exponential tween", () => { 
            ...
            let easeInOutExponentialTween: EaseInOutExponentialTween = new EaseInOutExponentialTween(tp);
            ...
            expect(easeInOutExponentialTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutExponentialTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
    ...
    describe('Quadratic Tweening algorithms', () => {
        it("should do an ease-in quadratic tween", () => { 
            ...
            let easeInQuadraticTween: EaseInQuadraticTween = new EaseInQuadraticTween(tp);
            expect(easeInQuadraticTween).toBeDefined();
            let returnedObj = easeInQuadraticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInQuadraticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInQuadraticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out quadratic tween", () => { 
            ...
            let easeOutQuadraticTween: EaseOutQuadraticTween = new EaseOutQuadraticTween(tp);
            expect(easeOutQuadraticTween).toBeDefined();
            let returnedObj = easeOutQuadraticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeOutQuadraticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutQuadraticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out quadratic tween", () => { 
            ...
            let easeInOutQuadraticTween: EaseInOutQuadraticTween = new EaseInOutQuadraticTween(tp);
            expect(easeInOutQuadraticTween).toBeDefined();
            let returnedObj = easeInOutQuadraticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInOutQuadraticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutQuadraticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
    ...
    describe('Quartic Tweening algorithms', () => {
        it("should do an ease-in quartic tween", () => { 
            ...
            let easeInQuarticTween: EaseInQuarticTween = new EaseInQuarticTween(tp);
            expect(easeInQuarticTween).toBeDefined();
            let returnedObj = easeInQuarticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInQuarticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInQuarticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out quartic tween", () => { 
            ...
            let easeOutQuarticTween: EaseOutQuarticTween = new EaseOutQuarticTween(tp);
            expect(easeOutQuarticTween).toBeDefined();
            let returnedObj = easeOutQuarticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeOutQuarticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutQuarticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out quartic tween", () => { 
            ...
            let easeInOutQuarticTween: EaseInOutQuarticTween = new EaseInOutQuarticTween(tp);
            expect(easeInOutQuarticTween).toBeDefined();
            let returnedObj = easeInOutQuarticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInOutQuarticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutQuarticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
    ...
    describe('Quintic Tweening algorithms', () => {
        it("should do an ease-in quintic tween", () => { 
            ...
            let easeInQuinticTween: EaseInQuinticTween = new EaseInQuinticTween(tp);
            expect(easeInQuinticTween).toBeDefined();
            let returnedObj = easeInQuinticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInQuinticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInQuinticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out quintic tween", () => { 
            ...
            let easeOutQuinticTween: EaseOutQuinticTween = new EaseOutQuinticTween(tp);
            expect(easeOutQuinticTween).toBeDefined();
            let returnedObj = easeOutQuinticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeOutQuinticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutQuinticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out quintic tween", () => { 
            ...
            let easeInOutQuinticTween: EaseInOutQuinticTween = new EaseInOutQuinticTween(tp);
            expect(easeInOutQuinticTween).toBeDefined();
            let returnedObj = easeInOutQuinticTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInOutQuinticTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutQuinticTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
    ...
    describe('Sinusoidal Tweening algorithms', () => {
        it("should do an ease-in sinusoidal tween", () => { 
            ...
            let easeInSinusoidalTween: EaseInSinusoidalTween = new EaseInSinusoidalTween(tp);
            expect(easeInSinusoidalTween).toBeDefined();
            let returnedObj = easeInSinusoidalTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInSinusoidalTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInSinusoidalTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-out sinusoidal tween", () => { 
            ...
            let easeOutSinusoidalTween: EaseOutSinusoidalTween = new EaseOutSinusoidalTween(tp);
            expect(easeOutSinusoidalTween).toBeDefined();
            let returnedObj = easeOutSinusoidalTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeOutSinusoidalTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseOutSinusoidalTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
        ...
        it("should do an ease-in-out sinusoidal tween", () => { 
            ...
            let easeInOutSinusoidalTween: EaseInOutSinusoidalTween = new EaseInOutSinusoidalTween(tp);
            expect(easeInOutSinusoidalTween).toBeDefined();
            let returnedObj = easeInOutSinusoidalTween.getObj()
            expect(returnedObj).toBeDefined()
            expect(easeInOutSinusoidalTween.toString()).toBe("Tween[Motion[obj={\"x\":5,\"y\":10,\"w\":50,\"h\":50}, prop=\"x\", _beginValue=5, _duration=10, useSeconds=false], funcName: EaseInOutSinusoidalTween, _valueChange: 10, _finishValue: 15, isComplete: false]")
            expect(rect.toString()).toBe("Rectangle[x=5, y=10, w=50, h=50]");
