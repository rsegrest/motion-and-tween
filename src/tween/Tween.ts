...
export class Tween extends Motion {
    ...
    public setParams(
        ...
        // else if (params.hasOwnProperty('duration')) {
        //     duration = (params as TweenForDurationParams).duration;
        //     // nextT = this._currentTime + params;
        // }
        // if (!nextT) {
            // nextT = this._currentTime + this._duration;
        // }
        if (!beginValue) {
